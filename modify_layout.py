  ...
  return (
    <div className="text-zinc-200 p-8 max-w-5xl mx-auto font-sans">
      <div className="mb-12">
        ...
        <p className="text-zinc-400 text-lg leading-relaxed max-w-3xl mb-6">{module.description}</p>
        ...
        {moduleId === 'html-beginner' && (
          <div className="bg-zinc-900 border-l-4 border-ds-indigo p-5 rounded-r-xl shadow-sm text-sm">
            ...
            <p className="text-zinc-400 leading-relaxed">
              ...
              (<code className="font-mono text-xs text-zinc-300">id</code>, <code className="font-mono text-xs text-zinc-300">class</code>, <code className="font-mono text-xs text-zinc-300">style</code>, <code className="font-mono text-xs text-zinc-300">title</code>, <code className="font-mono text-xs text-zinc-300">hidden</code>, <code className="font-mono text-xs text-zinc-300">tabindex</code>, <code className="font-mono text-xs text-zinc-300">lang</code>, <code className="font-mono text-xs text-zinc-300">dir</code>, <code className="font-mono text-xs text-zinc-300">data-*</code>, <code className="font-mono text-xs text-zinc-300">aria-*</code>, etc.) 
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1.5">
                                {data.required.map((attr: string) => (
                                  <span key={attr} className="font-mono text-[11px] px-2 py-0.5 rounded bg-rose-500/10 text-rose-400 border border-rose-500/20">
                                    {attr}
                                  </span>
                                ))}
                              </div>
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1.5">
                                {data.optional.map((attr: string) => (
                                  <span key={attr} className="font-mono text-[11px] px-2 py-0.5 rounded bg-zinc-800 text-zinc-400 border border-zinc-700">
                                    {attr}
                                  </span>
                                ))}
                              </div>
