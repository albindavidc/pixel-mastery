export const controlBarData = {
  layouts: [
    {
      group: 'Layout',
      properties: ['container', 'block', 'inline', 'inline-block', 'inline-flex', 'inline-grid', 'flex', 'grid', 'flow-root', 'contents', 'table', 'table-row', 'table-cell', 'hidden', 'box-border', 'box-content', 'overflow-*', 'overflow-x-*', 'overflow-y-*', 'overscroll-*', 'isolate', 'isolation-auto']
    },
    {
      group: 'Flex/Grid',
...
export const wildcards: Record<string, string[]> = {
  'flex': ['flex-row', 'flex-row-reverse', 'flex-col', 'flex-col-reverse', 'flex-wrap', 'flex-nowrap', 'flex-wrap-reverse'],
