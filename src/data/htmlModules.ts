...
export const htmlModules: Module[] = [
  {
    ...
    content: `{"tags": ["<!DOCTYPE>", "<html>", "<head>", "<body>", "<title>", "<meta>", "<link>", "<script>", "<div>", "<span>", "<h1>", "<h2>", "<h3>", "<h4>", "<h5>", "<h6>", "<p>", "<br>", "<hr>", "<a>", "<img>", "<ul>", "<ol>", "<li>", "<form>", "<label>", "<input>", "<textarea>", "<select>", "<option>", "<button>"], "categories": [{"name": "Document Structure", "color": "indigo", "tags": ["<!DOCTYPE>", "<html>", "<head>", "<body>", "<title>", "<meta>", "<link>", "<script>"]}, {"name": "Layout & Containers", "color": "emerald", "tags": ["<div>", "<span>"]}, {"name": "Headings & Text", "color": "rose", "tags": ["<h1>", "<h2>", "<h3>", "<h4>", "<h5>", "<h6>", "<p>", "<br>", "<hr>"]}, {"name": "Links & Media", "color": "amber", "tags": ["<a>", "<img>"]}, {"name": "Lists", "color": "cyan", "tags": ["<ul>", "<ol>", "<li>"]}, {"name": "Forms", "color": "teal", "tags": ["<form>", "<label>", "<input>", "<textarea>", "<select>", "<option>", "<button>"]}]}`,
    // groupId: 'html',
    // groupTitle: 'HTML',
    examples: [],
