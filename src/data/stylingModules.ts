...
,
  {
    ...
    title: 'Visual Effects & Filter',
    category: 'tailwind',
    description: 'Utilities for applying visual effects like shadows, opacity, filters, and masks.',
    content: `Visual Effects & Filter
...
<div class="p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg mt-4">
  ...
  <p class="text-amber-200/80 text-sm">Tailwind v4 consolidates complex arbitrary values and color families. Use the interactive tools above to generate the exact effect classes.</p>
    ...
    examples: [
      { label: 'Soft shadow', classes: 'shadow-lg shadow-indigo-500/30' },
      { label: 'Frosted glass', classes: 'backdrop-blur-md bg-white/10' },
      { label: 'Gradient mask', classes: 'mask-t-from-0% mask-t-to-100%' }
    ],
    challenge: {
      description: 'Give this card a soft indigo glow shadow and a frosted-glass backdrop blur.',
