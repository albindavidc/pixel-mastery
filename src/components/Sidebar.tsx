...
import { CheckCircle2, BookOpen, List, Code2, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {viewMode === 'curriculum' ? (
          <nav className="space-y-1">
            {!isCollapsed && <h3 className="px-3 text-xs font-bold text-zinc-500 uppercase tracking-widest mb-4">Curriculum Progress</h3>}
            {modules.map((module) => (
              <button
                key={module.id}
