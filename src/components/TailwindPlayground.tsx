  ...
  return (
    <div className="flex-1 flex flex-col h-full relative overflow-hidden bg-zinc-950">
      ...
      <div className="flex-1 overflow-auto p-4 md:p-8 flex flex-col relative bg-zinc-950">
        <div 
          className="flex-1 w-full max-w-2xl mx-auto min-h-[80vh] rounded-2xl border-2 border-slate-800/60 overflow-hidden relative shadow-2xl shadow-black/80 bg-zinc-900"
          style={{
