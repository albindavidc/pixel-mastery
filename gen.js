    ...
    <div className="mb-16">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 shadow-sm flex flex-col h-full">
          ...
          <div className="mt-auto p-4 bg-black/40 rounded-lg border border-zinc-800/80 border-l-2 border-l-ds-emerald/50">
            <pre className="font-mono text-[13px] text-zinc-300 whitespace-pre-wrap break-words leading-relaxed"><code className="block">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 shadow-sm flex flex-col h-full">
          ...
          <div className="mt-auto p-4 bg-black/40 rounded-lg border border-zinc-800/80 border-l-2 border-l-ds-rose/50">
            <pre className="font-mono text-[13px] text-zinc-300 whitespace-pre-wrap break-words leading-relaxed"><code className="block">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 shadow-sm flex flex-col h-full">
          ...
          <div className="mt-auto p-4 bg-black/40 rounded-lg border border-zinc-800/80 border-l-2 border-l-ds-amber/50">
            <pre className="font-mono text-[13px] text-zinc-300 whitespace-pre-wrap break-words leading-relaxed"><code className="block">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 shadow-sm flex flex-col h-full">
          ...
          <div className="mt-auto p-4 bg-black/40 rounded-lg border border-zinc-800/80 border-l-2 border-l-ds-cyan/50">
            <pre className="font-mono text-[13px] text-zinc-300 whitespace-pre-wrap break-words leading-relaxed"><code className="block">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 shadow-sm flex flex-col h-full">
          ...
          <div className="mt-auto p-4 bg-black/40 rounded-lg border border-zinc-800/80 border-l-2 border-l-ds-pink/50">
            <pre className="font-mono text-[13px] text-zinc-300 whitespace-pre-wrap break-words leading-relaxed"><code className="block">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 shadow-sm flex flex-col h-full sm:col-span-2 lg:col-span-1">
          ...
          <div className="mt-auto p-4 bg-black/40 rounded-lg border border-zinc-800/80 border-l-2 border-l-ds-teal/50">
            <pre className="font-mono text-[13px] text-zinc-300 whitespace-pre-wrap break-words leading-relaxed"><code className="block">
