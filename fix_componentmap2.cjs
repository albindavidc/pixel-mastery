...
const fileContent = `export const componentMap: Record<string, string[]> = ${JSON.stringify(componentMap, null, 2)};`;
fs.writeFileSync('src/components/showcase/componentMap.ts', fileContent, 'utf8');
